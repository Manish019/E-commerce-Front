...
const CategorySlider = () => {
  return (
    ...
    >
            <SwiperSlide>
              <div className="flex flex-col items-center justify-center p-4 bg-white rounded-lg border border-gray-200 shadow-md transition duration-300 hover:shadow-xl hover:border-orange-400">
