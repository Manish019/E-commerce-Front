...
<Link to="#" className="flex text-[14px] mt-2 text-black hover:text-red-600"><MdOutlineMailOutline className="text-[20px] mr-2" />
  support@gmail.com</Link>
<Link to="#" className="flex text-[14px] mt-2 text-black hover:text-red-600"><PiPhoneCallDuotone className="text-[20px] mr-2" />
 +1800 000 000</Link>

 <div className="social-icons flex items-center justify-start mt-4">
    <Link to="#" className="flex items-center justify-center rounded-full mr-2"><FaSquareFacebook className="text-[30px] text-red-500 hover:text-black" />
</Link>
    <Link to="#" className="flex items-center justify-center rounded-full mr-2"><FaSquareXTwitter  className="text-[30px] text-red-500 hover:text-black" /></Link>
    <Link to="#" className="flex items-center justify-center rounded-full mr-2"><FaSquareInstagram   className="text-[30px] text-red-500 hover:text-black" /></Link>
    <Link to="#" className="flex items-center justify-center rounded-full mr-2"><FaLinkedin  className="text-[30px] text-red-500 hover:text-black" /></Link>
    <Link to="#" className="flex items-center justify-center rounded-full mr-2"><FaSquareYoutube  className="text-[30px] text-red-500 hover:text-black" /></Link>
 </div>
   ...
   <div className="flex flex-col items-start justify-start">
    ...
    <ul>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Prices drop</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">New products</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Best sales</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Contact us</Link></li>
            <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Sitemap</Link></li>

      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Stores</Link></li>
    </ul>
   ...
   <div className="flex flex-col items-start justify-start">
    ...
    <ul>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Delivery</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Legal Notice</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Secure payment</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Contact us</Link></li>
      <li className="text-[13px] mt-2 text-black hover:text-red-600"><Link to="#">Sitemap</Link></li>
    </ul>
...
<form action="/" className="w-full mt-4">
  <input type="text" className="w-full h-[45px] border-2  rounded-2xl outline-none focus:border-red-600 pl-2 pr-2" placeholder="Enter your email" />
   <button className="w-2/4 h-[35px] bg-red-600 text-white rounded-2xl mt-2 hover:bg-black">Subscribe</button>
